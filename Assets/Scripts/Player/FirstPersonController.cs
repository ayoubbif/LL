...
namespace KKL.Player
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [SerializeField, Range(1, 50)] private float xSensitivity = 30.0f;
        [SerializeField, Range(1, 50)] private float ySensitivity = 30.0f;
        ...
        [SerializeField] private float stairsSpeed = 1.0f;
        ...
        private bool IsOnStairs() => 
            Physics.Raycast(_playerCamera.transform.position,
                ...
                out var hit,
                3) &&
            hit.collider.CompareTag(_stairsTag);
    }
}